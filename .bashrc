...
function in_git_repo_dir {
  ...
  if [ `pwd` != $base_dir ]; then ps_git_dir=" \\[\e[01;35m\\]$rel_path\\[\e[0m\\]"; else ps_git_dir=""; fi
}
...
function set_ps1 {
  if [ -z "$(git rev-parse 2>&1)" ]
    then
      ...
      PS1='\[\033]0;\W\007\]\[\e[01;35m\]\u@\h\[\e[0m\]\[\e[01;33m\]:\[\e[0m\]\[\e[01;36m\]\w\[\e[0m\] \[\e[01;38m\]\$\[\e[0m\] '
  fi
}
